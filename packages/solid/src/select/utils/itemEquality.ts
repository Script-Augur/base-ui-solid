/**
 * Default item-equality comparison for Select values.
 *
 ...
 *
 * @param itemValue - Value declared on a `Select.Item`.
...
/**
 * Removes the first item matching `value` from `list` (multiple-select
 * toggle-off), comparing with {@link compareItemEquality}.
 *
 * @param list - Current multiple-select value array.
