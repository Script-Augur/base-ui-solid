/**
 * `data-*` attribute names written by {@link CheckboxIndicator}.
 *
 * Catalog for docs and consumers styling or querying indicator state.
 */
export const CheckboxIndicatorDataAttributes = {
  /**
