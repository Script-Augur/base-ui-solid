/**
 * `data-*` attribute names written by {@link CheckboxRoot}.
 *
 * Catalog for docs and consumers styling or querying checkbox state.
 */
export const CheckboxRootDataAttributes = {
  /**
