...
| Behavior                                                             | Notes                                                              |
| -------------------------------------------------------------------- | ------------------------------------------------------------------ |
| Payload children TS prop typing                                      | Same Solid JSX transform note as Dialog — runtime render-prop OK; `children` typed as `JSX.Element`; detection uses `fn.length > 0` |
