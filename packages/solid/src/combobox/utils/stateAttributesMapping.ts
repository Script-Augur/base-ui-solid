...
/**
 * Shared by `Combobox.Popup` / positioner-adjacent parts that expose open +
 * transition + side / align.
 */
export const comboboxPopupStateAttributesMapping: StateAttributesMapping<{
  open: boolean
 ...
 */
export const comboboxTransitionStateMapping: StateAttributesMapping<{
  open: boolean
  transitionStatus: TransitionStatus
}> = {
  open(value) {
 ...
 */
export const comboboxPositionerStateAttributesMapping: StateAttributesMapping<{
  open: boolean
  side: Side
  align: Align
 ...
 */
export const comboboxTriggerOpenStateMapping: StateAttributesMapping<{
  open: boolean
}> = {
  open(value) {
 ...
 */
export const comboboxTriggerStateAttributesMapping: StateAttributesMapping<{
  open: boolean
  valid: boolean | null
}> = {
  ...comboboxTriggerOpenStateMapping,
