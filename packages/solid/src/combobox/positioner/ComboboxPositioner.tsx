...
/**
 * Positions the combobox popup against the trigger.
...
export function ComboboxPositioner(
  componentProps: ComboboxPositionerProps
): JSX.Element {
  ...
  return (
    <Show when={shouldRender()}>
      <ComboboxPositionerContext.Provider value={positionerContext}>
        {createRender<ComboboxPositionerState, Record<string, unknown>>({
          defaultElement: 'div',
          state,
          render: local.render,
          mapStateToDataAttributes: true,
          stateAttributesMapping:
            comboboxPositionerStateAttributesMapping as StateAttributesMapping<ComboboxPositionerState>,
          props: mergeProps(elementProps as Record<string, unknown>, {
            ...
            get style() {
              ...
              const base: JSX.CSSProperties = {
                ...
                [ComboboxPositionerCssVars.transformOrigin]: `${resolved().align} ${resolved().side}`,
              }
...
/** Public state for {@link ComboboxPositioner}. */
export interface ComboboxPositionerState extends Record<string, unknown> {
  open: boolean
  side: Side
  align: Align
...
/** Props for {@link ComboboxPositioner}. */
export type ComboboxPositionerProps = JSX.HTMLAttributes<HTMLDivElement> & {
  ...
  render?: RenderProp<ComboboxPositionerState, Record<string, unknown>>
}
